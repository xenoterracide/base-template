...
export default defineConfig([
  globalIgnores([".yarn/", ".pnp.*", "dist/", "build/", "node_modules/", ".agents/", "node/packages/merge/"]),
  {
  ...
  },
  {
    ...
    rules: {
      // Strict rules from mira - commented out for gradual adoption
      // "max-params": "off",
      ...
      // Relaxed rules for current codebase
